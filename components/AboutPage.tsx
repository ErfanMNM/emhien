      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6 animate-in fade-in duration-500">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 overflow-hidden relative">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 text-lg font-medium mb-2">Phiên bản 1.0.9</p>
            <p className="text-gray-500 text-sm">Quản lý lịch học và bài tập cá nhân hóa</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between items-center py-2 border-b border-blue-100">
              ...
              <span className="font-bold text-gray-800">1.0.9 - Siêu Vip</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-blue-100">
